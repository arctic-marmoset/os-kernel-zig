...
pub fn init() !void {
    ...
    const new_page_table = try deepCopyPageTable(page_table);
...
pub fn deepCopyPageTable(
    page_table: *align(std.mem.page_size) native.PML4,
) !*align(std.mem.page_size) native.PML4 {
